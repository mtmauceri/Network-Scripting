...
with open('devices_file') as select_devices:
    devices_list = f.read().splitlines()

#for line in select_devices:
#  currentline = line.split(",")
#  total = str(int(currentline[0])) + int(currentline[1]) + "\n"
#  select_devices.write(total)
#  multiple_devices = int(raw_input('What combinatin of devices would you like to do 1,2,3: '))
#  for select_devices in multiple_devices:
#    if multiple_devices == '1'
#      ip_address_of_device = int(currentline[0])
#      if multiple_devices =
